...
test "parseTimestamp with partial nanoseconds" {
    ...
    try std.testing.expectEqual(try parseTimestamp("2025-01-01T00:00:00.1Z"), try parseTimestamp("2025-01-01T00:00:00.100000000Z"));

    try std.testing.expectEqual(try parseTimestamp("2025-01-01T00:00:00.12Z"), try parseTimestamp("2025-01-01T00:00:00.120000000Z"));

    try std.testing.expectEqual(try parseTimestamp("2025-01-01T00:00:00.123Z"), try parseTimestamp("2025-01-01T00:00:00.123000000Z"));
}
