...
| ------------------------------------------------------------------------------ | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- |
| `$JS.API.CONSUMER.CREATE.<stream>.>` and/or `$JS.API.CONSUMER.CREATE.<stream>` | outbound  | <p>Create an ephemeral consumer to deliver pending messages. Note that this subject may be prefixed with a JetStream domain <code>$JS.&#x3C;domain>.API.CONSUMER.CREATE.&#x3C;stream>.&#x3C;consumer></code>.<br>The consumer create comes in 2 flavors depending on the number of filter subjects:<br>* <code>$JS.API.CONSUMER.CREATE.&#x3C;stream></code> - When there is no filter or there are multiple filters.<br>* <code>$JS.API.CONSUMER.CREATE.&#x3C;stream>.&#x3C;consumer>.&#x3C;filter subject></code> - When there is exactly one filter subject</p> | service request with `$JSC.R.<uid>` as reply subject |
